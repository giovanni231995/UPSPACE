...
st.sidebar.write(f"Carica il file Excel cliccando nel link a seguire: [Repository](https://github.com/giovanni231995/UPSPACE/upload/main) --> Ricorda che il file Excel deve essere nominato: [Upspace.xlsx]")
